        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_Users_CreatedByCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CertificatedId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ActivityId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Certificates", x => x.CertificatedId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Certificates_Users_IssuedByCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_IssuedByCompanyId",
                table: "Certificates",
